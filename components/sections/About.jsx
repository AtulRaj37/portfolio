    ...
    return (
        <div className='bg-[#000] text-white'>
            ...
            <div className='mt-24'>
                ...
                <div className='relative z-10 m-auto border-0 border-red-500 sm1:flex sm1:flex-col md:grid md:grid-cols-2 xl:w-3/5 mt-28 sm1:w-11/12 md:w-3/4'>
                    <div className='font-bold text-blue-400 border-0 border-red-500 xl:text-center sm1:text-left sm1:mb-3 md:mb-0'>Background</div>
                    <div className='border-0 border-red-500 sm1:w-full md:text-sm sm1:text-xs xl:w-3/4'>
